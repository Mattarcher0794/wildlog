...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "theme-color", content: "#f6ece0" },
      { title: "Wildeye — Snap any animal, learn its name" },
      { property: "og:title", content: "Wildeye — Snap any animal, learn its name" },
      { name: "twitter:title", content: "Wildeye — Snap any animal, learn its name" },
      { name: "description", content: "Wildeye identifies any animal from a single photo — mammals, birds, reptiles, insects and more — enriching your nature observations." },
      { property: "og:description", content: "Wildeye identifies any animal from a single photo — mammals, birds, reptiles, insects and more — enriching your nature observations." },
      { name: "twitter:description", content: "Wildeye identifies any animal from a single photo — mammals, birds, reptiles, insects and more — enriching your nature observations." },
