...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Bird Buddy identifies bird species from photos, enriching your nature observations." },
      { property: "og:description", content: "Bird Buddy identifies bird species from photos, enriching your nature observations." },
      { name: "twitter:description", content: "Bird Buddy identifies bird species from photos, enriching your nature observations." },
