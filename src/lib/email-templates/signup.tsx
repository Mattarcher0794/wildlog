    ...
    <Body style={main}>
      <Container style={container}>
        <Section style={card}>
          ...
          <Heading style={h1}>Enter this code to get started</Heading>
          <Text style={text}>
            Welcome to {siteName}! Type this 6-digit code into the window you
            just left open to finish signing in.
          </Text>
